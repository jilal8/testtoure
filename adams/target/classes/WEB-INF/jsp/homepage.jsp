...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<div class="container">
			<a class="navbar-brand" href="/">Mahdi Hassan Djilal</a>
			...
			<div class="col-lg-3">
				...
				<div class="list-group">
					...
					<form id="clothesfilter"
						action="${pageContext.request.contextPath}/category" method="POST">
						<input type="hidden" 
							name="category" value="clothes" /> <a class="list-group-item"
							href="javascript:{}"
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form id="addproductform"
									  ...
									  method="post">
									<!-- Choisir l'url adéquate et la méthode http voulue -->
